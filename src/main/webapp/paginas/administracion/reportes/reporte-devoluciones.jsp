<%-- 
    ...
    Created on : Sep 5, 2021, 7:20:36 PM
    Author     : fernanrod
--%>
	...
	<jsp:include page = "/includes/header.jsp"></jsp:include>
		<div class="container-fluid">
		    ...
		    <jsp:include page = "/includes/sidebar-administracion-reportes.jsp"></jsp:include>
				...
				<h2 class="vertical-center" style="margin-left: 40%" id="formBusqueda">Reporte Devoluciones</h2>
				<form class="input-group m-auto vertical-center" style="max-width: 70%" action="reporte-devoluciones.jsp" method="GET">
				...
				<small id="notaBusqueda" class="form-text text-muted" style="margin-left: 15.3%">
				    Se mostraran los datos entre ambas fechas sin importar cual sea mayor. Si no ingresas alguna de las fechas se mostraran todas las devoluciones.
				</small>
			    <c:if test="${param.primerFecha != null}">
				    <script>
					    document.getElementById("formBusqueda").className = "mb-3";
				    </script>
				    <jsp:include page="resultados-reporte-devoluciones.jsp"/>
			    </c:if>
		    </div>
		</div>
	</div>
