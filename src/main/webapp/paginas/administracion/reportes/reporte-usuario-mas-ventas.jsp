<%-- 
    Document   : reporte-usuario-mas-ventas
    Created on : Sep 5, 2021, 7:21:00 PM
    Author     : fernanrod
--%>
	...
	<jsp:include page = "/includes/header.jsp"></jsp:include>
		<div class="container-fluid">
		    ...
		    <jsp:include page = "/includes/sidebar-administracion-reportes.jsp"></jsp:include>
				...
				<h2 class="vertical-center" style="margin-left: 40%" id="formBusqueda">Ranking de Ventas</h2>
				<form class="input-group m-auto vertical-center" style="max-width: 70%" action="reporte-usuario-mas-ventas.jsp" method="GET">
			    ...
			    <c:if test="${param.primerFecha != null}">
				    ...
				    <jsp:include page="resultados-reporte-usuario-mas-ventas.jsp"/>
			    </c:if>
		    </div>
		</div>
	</div>
