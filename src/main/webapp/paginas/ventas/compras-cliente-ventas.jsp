<%-- 
    Document   : compras-cliente-ventas
    Created on : Sep 5, 2021, 11:24:20 PM
    Author     : fernanrod
--%>
	...
	<jsp:include page = "/includes/header.jsp"></jsp:include>
		<div class="container-fluid">
		    ...
		    <jsp:include page = "/includes/sidebar-ventas-consultas.jsp"></jsp:include>
				...
				<h2 class="vertical-center" style="margin-left: 40%" id="formBusqueda">Compras de un Cliente</h2>
				<form class="m-auto" style="max-width: 70%" action="compras-cliente-ventas.jsp" method="GET">
				...
				Se mostraran los datos entre ambas fechas sin importar cual sea mayor. Si no ingresas alguna de las fechas se mostraran todas las compras del cliente.
			    </small>
			    <c:if test="${param.nit != null}">
				    <script>
                                            document.getElementById("formBusqueda").className = "mb-3";
				    </script>
				    <jsp:include page="resultado-compras-cliente.jsp"/>
			    </c:if>
		    </div>
		</div>
	</div>
	<jsp:include page = "/includes/volver-footer.jsp"><jsp:param name="home" value="${pageContext.request.contextPath}/paginas/devoluciones.jsp"/></jsp:include>
