<%-- 
    Document   : reporte-mueble-mas-vendido
    Created on : Sep 5, 2021, 7:21:55 PM
    Author     : fernanrod
--%>
	...
	<jsp:include page = "/includes/header.jsp"></jsp:include>
		<div class="container-fluid">
		    ...
		    <jsp:include page = "/includes/sidebar-administracion-reportes.jsp"></jsp:include>
				...
				<h2 class="vertical-center" style="margin-left: 40%" id="formBusqueda">Ranking de Descendente de Venta de Muebles</h2>
				<form class="input-group m-auto vertical-center" style="max-width: 70%" action="reporte-mueble-mas-vendido.jsp" method="GET">
				    ...
				    <input type="hidden" id="segundaFecha" name="orden" value="true">
				</form>
